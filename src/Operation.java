public class Operation {
    public static void main(String[] args) {
        ...
        boolean flag = false;
        boolean notFlag = !flag; // flag가 flase일 때, notFlag는 true

        System.out.println("notflag = " + notFlag); // true
        boolean flag2 = !notFlag;
        System.out.println("flag2 = " + flag2); // flase
        ...
        int xx = 5;
        xx += 3;  // xx에 3을 더한 후 저장 xx = xx + 3, 결과: 8
        xx *= 2;  // xx에 2를 곱한 후 저장 xx = xx + 2, 결과: 16
        xx <<= 1; // xx를 왼쪽으로 1비트 이동 후 저장 xx = xx << 3, 결과: 32
    }
}
